...
void NPC(Data& data) {
    ...
    case 0:
        ...
        //int rand_gold = rand() % 50 + 10;
        //data.gold + rand_gold;
        //cout << "За выполнение квеста" << endl;
        break;
    case 5:
...
void Shop(Data& data) {
    ...
    case 1:
        if (data.gold >= 40) {
            if (data.hp == 100) {
                ...
                data.hp = min(100, data.hp + 35);
                data.gold -= 40;
                cout << "Вы выпили Большое зелье здоровья. Теперь у вас " << data.hp << " HP." << endl;
            }
        }
        else {
            cout << "Недостаточно золота! Нужно 40 золота." << endl;
            BattleResult battle(Data & data, LocationType locationType);
        }
        break;
    ...
    case 2:
        if (data.gold >= 30) {
            if (data.hp == 100) {
                ...
                data.hp = min(100, data.hp + 25);
                data.gold -= 30;
                cout << "Вы выпили Среднее зелье здоровья. Теперь у вас " << data.hp << " HP." << endl;
            }
        }
        else {
    ...
    case 3:
        if (data.gold >= 20) {
            if (data.hp == 100) {
                ...
                data.hp = min(100, data.hp + 15);
                data.gold -= 20;
                cout << "Вы выпили Малое зелье здоровья. Теперь у вас " << data.hp << " HP." << endl;
            }
        }
        else {
            cout << "Недостаточно золота! Нужно 20 золота." << endl;
            BattleResult battle(Data & data, LocationType locationType);
        }
        break;
    ...
    case 4:
        if (data.gold >= 120) {
            data.gun = 3;
            data.gold -= 120;
            cout << "Вы купили Боевой топор! Теперь ваше оружие - Боевой топор." << endl;
        }
        else {
            cout << "Недостаточно золота! Нужно 120 золота." << endl;
            BattleResult battle(Data & data, LocationType locationType);
        }
        break;
    ...
    case 5:
        if (data.gold >= 80) {
            ...
            cout << "Недостаточно золота! Нужно 80 золота." << endl;
            BattleResult battle(Data & data, LocationType locationType);
        }
        break;
    ...
    case 6:
        if (data.gold >= 50) {
            ...
            cout << "Недостаточно золота! Нужно 50 золота." << endl;
            BattleResult battle(Data & data, LocationType locationType);
        }
        break;
...
int main() {
    ...
    while (true) {
        ...
        case 1: {
            ...
            cin >> playerData.name;
            cout << endl;
            cout << "Привет путник, вижу ты тут впервые..." << endl;
            cout<< "Если хочешь заполучить мое доверие - тебе нужно будет выполнить несколько моих заданий!" << endl;
